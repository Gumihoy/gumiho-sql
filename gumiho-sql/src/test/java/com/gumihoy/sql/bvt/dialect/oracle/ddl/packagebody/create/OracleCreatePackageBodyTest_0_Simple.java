package com.gumihoy.sql.bvt.dialect.oracle.ddl.packagebody.create;
 ...
 */
public class OracleCreatePackageBodyTest_0_Simple {

    @Test
    public void test_0() {
        String sql = "CREATE OR REPLACE PACKAGE BODY emp_mgmt AS \n" +
                "   tot_emps NUMBER; \n" +
                "   tot_depts NUMBER; \n" +
                "FUNCTION hire \n" +
