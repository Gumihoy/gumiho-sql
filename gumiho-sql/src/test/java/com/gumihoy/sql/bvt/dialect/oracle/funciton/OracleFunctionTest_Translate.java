 ...
 */
public class OracleFunctionTest_Translate {
    ...
    @Test
    public void test_1() {
        String sql = "UPDATE translate_tab \n" +
        ...
        System.out.println("----------------");
        System.out.println(format);
        Assert.assertEquals("UPDATE translate_tab\n" +
                "SET char_col = TRANSLATE(nchar_col USING CHAR_CS);", format);
    }
