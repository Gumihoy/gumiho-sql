...
public class MySQLLexer extends SQLLexer {
    ...
    public final static SQLReservedWords DEFAULT_MYSQL_RESERVED_WORDS;
...
//        put(defaultKeyWordsMap, SQLToken.TokenKind.YEAR);
        ...
        // Z
        DEFAULT_MYSQL_RESERVED_WORDS = new SQLReservedWords(defaultKeyWordsMap);

        RESERVED_WORDS = DEFAULT_MYSQL_RESERVED_WORDS;
    }
    ...
    public MySQLLexer(String sql, SQLLexerConfig config) {
        this(sql, DBType.MySQL, config);
    }

    public MySQLLexer(String sql, DBType dbType, SQLLexerConfig config) {
        super(sql, dbType, config);
    }
