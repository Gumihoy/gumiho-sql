...
public class PostgreSQLLexer extends SQLLexer {
    ...
    public final static SQLReservedWords DEFAULT_POSTGRESQL_RESERVED_WORDS;
...
//        put(defaultKeyWordsMap, SQLToken.TokenKind.TRUE);
        ...
        // Z
        DEFAULT_POSTGRESQL_RESERVED_WORDS = new SQLReservedWords(defaultKeyWordsMap);
        RESERVED_WORDS = DEFAULT_POSTGRESQL_RESERVED_WORDS;
    }


    public PostgreSQLLexer(String input) {
        this(input, null);
    }

    public PostgreSQLLexer(String input, SQLLexerConfig config) {
        super(input, DBType.PostgreSQL, config);
    }
}
