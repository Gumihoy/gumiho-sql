 ...
 */
public class MySQLASTOutputVisitor extends SQLASTOutputVisitor implements IMySQLASTVisitor {

    public MySQLASTOutputVisitor(StringBuilder appender) {
        super(appender);
    }

    public MySQLASTOutputVisitor(StringBuilder appender, SQLOutputConfig config) {
