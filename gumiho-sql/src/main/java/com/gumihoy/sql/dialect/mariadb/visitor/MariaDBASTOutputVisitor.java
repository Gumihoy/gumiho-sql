package com.gumihoy.sql.dialect.mariadb.visitor;
 ...
 */
public class MariaDBASTOutputVisitor extends SQLASTOutputVisitor implements IMySQLASTVisitor {

    public MariaDBASTOutputVisitor(StringBuilder appender) {
        super(appender);
    }

    public MariaDBASTOutputVisitor(StringBuilder appender, SQLOutputConfig config) {
