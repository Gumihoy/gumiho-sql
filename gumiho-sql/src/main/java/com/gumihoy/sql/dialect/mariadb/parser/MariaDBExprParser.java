...
import com.gumihoy.sql.dialect.mariadb.parser.statement.MariaDBIndexStatementParser;
import com.gumihoy.sql.dialect.mariadb.parser.statement.MariaDBTableStatementParser;
...
import com.gumihoy.sql.dialect.mysql.parser.MySQLLexer;
 ...
 */
public class MariaDBExprParser extends SQLExprParser {

    public MariaDBExprParser(String sql) {
        this(new MariaDBLexer(sql));
    }

    public MariaDBExprParser(String sql, SQLParseConfig config) {
        this(new MariaDBLexer(sql, config), config);
    }

    public MariaDBExprParser(MariaDBLexer lexer) {
        super(lexer);
    }

    public MariaDBExprParser(MariaDBLexer lexer, SQLParseConfig config) {
        super(lexer, config);
    }
    ...
    protected static final Set<Long> MYSQL_NO_ARGUMENT_FUNCTION = new HashSet<>();
    {
        MYSQL_NO_ARGUMENT_FUNCTION.add(SQLKeyWord.CURRENT_DATE.lowerHash);
        MYSQL_NO_ARGUMENT_FUNCTION.add(SQLKeyWord.CURRENT_TIME.lowerHash);
        MYSQL_NO_ARGUMENT_FUNCTION.add(SQLKeyWord.CURRENT_TIMESTAMP.lowerHash);
        MYSQL_NO_ARGUMENT_FUNCTION.add(SQLKeyWord.CURRENT_USER.lowerHash);
        MYSQL_NO_ARGUMENT_FUNCTION.add(SQLKeyWord.LOCALTIME.lowerHash);
        MYSQL_NO_ARGUMENT_FUNCTION.add(SQLKeyWord.LOCALTIMESTAMP.lowerHash);
        MYSQL_NO_ARGUMENT_FUNCTION.add(SQLKeyWord.UTC_DATE.lowerHash);
        MYSQL_NO_ARGUMENT_FUNCTION.add(SQLKeyWord.UTC_TIME.lowerHash);
        MYSQL_NO_ARGUMENT_FUNCTION.add(SQLKeyWord.UTC_TIMESTAMP.lowerHash);

        noArgumentFunctionLowerHash = MYSQL_NO_ARGUMENT_FUNCTION;
    }


    @Override
    protected SQLDatabaseStatementParser createDatabaseStatementParser() {
        return new MySQLDatabaseStatementParser(this);
    }
    ...
    protected SQLIndexStatementParser createIndexStatementParser() {
        return new MariaDBIndexStatementParser(this);
    }

    @Override
    protected SQLSchemaStatementParser createSchemaStatementParser() {
        return new MySQLSchemaStatementParser(this);
    }

    @Override
    protected SQLTableStatementParser createTableStatementParser() {
        return new MariaDBTableStatementParser(this);
    }
