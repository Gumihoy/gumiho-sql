...
import com.gumihoy.sql.dialect.mysql.parser.statement.MySQLTriggerStatementParser;
import com.gumihoy.sql.dialect.mysql.parser.statement.MySQLViewStatementParser;
...
public class MySQLExprParser extends SQLExprParser {
    ...
    public MySQLExprParser(String sql, SQLParseConfig config) {
        this(new MySQLLexer(sql, config), config);
    }
    ...
    public MySQLExprParser(SQLLexer lexer, SQLParseConfig config) {
        super(lexer, config);
    }
    ...
    protected SQLIndexStatementParser createIndexStatementParser() {
        return new MySQLIndexStatementParser(this);
    }
    ...
    protected SQLTableStatementParser createTableStatementParser() {
        return new MySQLTableStatementParser(this);
    }

    @Override
    protected SQLTriggerStatementParser createTriggerStatementParser() {
        return new MySQLTriggerStatementParser(this);
    }

    @Override
    protected SQLViewStatementParser createViewStatementParser() {
        return new MySQLViewStatementParser(this);
    }
