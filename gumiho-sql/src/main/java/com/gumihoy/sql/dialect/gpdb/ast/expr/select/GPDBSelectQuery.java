...
import com.gumihoy.sql.dialect.gpdb.ast.expr.IGPDBExpr;
 ...
 */
public class GPDBSelectQuery extends SQLSelectQuery implements IGPDBExpr {
    ...
    @Override
    public void accept0(IGPDBASTVisitor visitor) {
