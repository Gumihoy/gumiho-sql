 ...
 */
public class GPDBLexer extends SQLLexer {


    public final static SQLReservedWords DEFAULT_GPDB_RESERVED_WORDS;
...
//        put(defaultKeyWordsMap, SQLToken.TokenKind.YEAR);
        ...
        // Z
        DEFAULT_GPDB_RESERVED_WORDS = new SQLReservedWords(defaultKeyWordsMap);

        RESERVED_WORDS = DEFAULT_GPDB_RESERVED_WORDS;
    }

    public GPDBLexer(String sql) {
        this(sql, null);
    }

    public GPDBLexer(String sql, SQLLexerConfig config) {
        super(sql, DBType.MySQL, config);
