 ...
 */
public class MariaDBLexer extends MySQLLexer {


    public final static SQLReservedWords DEFAULT_MARIADB_RESERVED_WORDS;
...
//        put(defaultKeyWordsMap, SQLToken.TokenKind.AUTHORIZATION);
        ...
        put(defaultKeyWordsMap, SQLToken.TokenKind.BINARY);
...
//        put(defaultKeyWordsMap, SQLToken.TokenKind.LEADING);
        ...
        put(defaultKeyWordsMap, SQLToken.TokenKind.LIMIT);
...
//        put(defaultKeyWordsMap, SQLToken.TokenKind.USER); 不能用，有可能是 ID
        put(defaultKeyWordsMap, SQLToken.TokenKind.USING);


        // V
//        put(defaultKeyWordsMap, SQLToken.TokenKind.VALUE); 不能用，有可能是 as value
//        put(defaultKeyWordsMap, SQLToken.TokenKind.VALUES); 不能用，有可能是 function name
...
//        put(defaultKeyWordsMap, SQLToken.TokenKind.YEAR);
        ...
        // Z
        DEFAULT_MARIADB_RESERVED_WORDS = new SQLReservedWords(defaultKeyWordsMap);

        RESERVED_WORDS = DEFAULT_MARIADB_RESERVED_WORDS;
    }

    public MariaDBLexer(String sql) {
        this(sql, null);
    }

    public MariaDBLexer(String sql, SQLLexerConfig config) {
        super(sql, DBType.MariaDB, config);
    ...
    public void scanBQuotaString() {
        kind = SQLToken.TokenKind.REVERSE_QUOTED_IDENTIFIER;
        scanString();
    }
