 ...
 */
public class SQLDropUserStatement extends AbstractSQLStatement implements ISQLDropStatement {
    ...
    @Override
    public SQLDropUserStatement clone() {
        return null;
    }

    @Override
    public SQLObjectType getObjectType() {
        return SQLObjectType.USER_DROP;
    }
}
