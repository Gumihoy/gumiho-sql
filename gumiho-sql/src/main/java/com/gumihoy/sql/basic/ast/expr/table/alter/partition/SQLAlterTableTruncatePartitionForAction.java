 ...
 */
public class SQLAlterTableTruncatePartitionForAction extends AbstractSQLAlterTableTruncatePartitionAction implements ISQLAlterTableAction {
...
//            this.acceptChild(visitor, parallelClause);
    ...
    @Override
    public SQLAlterTableTruncatePartitionForAction clone() {
        SQLAlterTableTruncatePartitionForAction x = new SQLAlterTableTruncatePartitionForAction();
        this.cloneTo(x);
//        x.type = this.type;
        return x;
    }
