 ...
 */
public abstract class AbstractSQLAlterTableSplitSubPartitionAction extends AbstractSQLExpr implements ISQLAlterTablePartitionAction {
...
//    protected SQLAllowDisallowClusteringType allowDisallowClustering;
    ...
    @Override
    public AbstractSQLAlterTableSplitSubPartitionAction clone() {
        throw new UnsupportedOperationException(getClass().getName());
    }

    public void cloneTo(AbstractSQLAlterTableSplitSubPartitionAction x) {
        super.cloneTo(x);
    ...
    public static abstract class AbstractSQLItem extends AbstractSQLExpr implements SQLItem {
        ...
        public void cloneTo(AbstractSQLItem x) {
            ...
            for (SQLSubPartitionDefinition subPartition : subPartitions) {
                ...
                x.addPartition(subPartitionClone);
            }
        }
        ...
        public void addPartition(SQLSubPartitionDefinition subPartition) {
