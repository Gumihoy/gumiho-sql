 ...
 */
public class SQLAlterTableTruncateSubPartitionForAction extends AbstractSQLAlterTableTruncatePartitionAction implements ISQLAlterTableAction {
...
//            this.acceptChild(visitor, parallelClause);
    ...
    @Override
    public SQLAlterTableTruncateSubPartitionForAction clone() {
        SQLAlterTableTruncateSubPartitionForAction x = new SQLAlterTableTruncateSubPartitionForAction();
        this.cloneTo(x);
        return x;
    }

    public void cloneTo(SQLAlterTableTruncateSubPartitionForAction x) {
        super.cloneTo(x);
//        x.type = this.type;
    }
