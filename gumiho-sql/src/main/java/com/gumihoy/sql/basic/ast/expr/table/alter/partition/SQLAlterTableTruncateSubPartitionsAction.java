 ...
 */
public class SQLAlterTableTruncateSubPartitionsAction extends AbstractSQLAlterTableTruncatePartitionAction implements ISQLAlterTableAction {
...
//            this.acceptChild(visitor, parallelClause);
    ...
    @Override
    public SQLAlterTableTruncateSubPartitionsAction clone() {
        SQLAlterTableTruncateSubPartitionsAction x = new SQLAlterTableTruncateSubPartitionsAction();
        this.cloneTo(x);
        return x;
    }

    public void cloneTo(SQLAlterTableTruncateSubPartitionsAction x) {
        super.cloneTo(x);
//        x.type = this.type;
    }
