 ...
 */
public interface ISQLIlmClause extends ISQLExpr, ISQLPhysicalProperty {
    @Override
    ISQLIlmClause clone();
     ...
     * https://docs.oracle.com/en/database/oracle/oracle-database/18/sqlrf/CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6
     */
    interface SQLIlmPolicyClause extends ISQLExpr {
        @Override
        SQLIlmPolicyClause clone();
    }
     ...
     */
    interface SQLIlmCompressionPolicy extends SQLIlmPolicyClause {
    }

    /**
//     * table_compression
//     */
//    class SQLIlmCompressionPolicyByTableCompression extends AbstractSQLExpr implements SQLIlmCompressionPolicy {
//        protected ISQLCompression tableCompression;
