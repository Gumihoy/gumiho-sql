 ...
 */
public class SQLAlterTableAnalyzePartitionAction extends AbstractSQLExpr implements ISQLAlterTableAction {
...
//        }
    ...
    @Override
    public SQLAlterTableAnalyzePartitionAction clone() {
        SQLAlterTableAnalyzePartitionAction x = new SQLAlterTableAnalyzePartitionAction();
        this.cloneTo(x);
        return x;
    }

    public void cloneTo(SQLAlterTableAnalyzePartitionAction x) {
        super.cloneTo(x);
