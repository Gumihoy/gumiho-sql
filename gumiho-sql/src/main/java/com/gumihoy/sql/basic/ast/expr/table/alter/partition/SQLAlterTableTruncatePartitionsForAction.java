 ...
 */
public class SQLAlterTableTruncatePartitionsForAction extends AbstractSQLAlterTableTruncatePartitionAction implements ISQLAlterTableAction {
...
//            this.acceptChild(visitor, parallelClause);
    ...
    @Override
    public SQLAlterTableTruncatePartitionsForAction clone() {
        SQLAlterTableTruncatePartitionsForAction x = new SQLAlterTableTruncatePartitionsForAction();
        this.cloneTo(x);
//        x.type = this.type;
        return x;
    }
