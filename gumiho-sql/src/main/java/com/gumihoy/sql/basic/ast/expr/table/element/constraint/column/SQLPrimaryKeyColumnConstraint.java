...
public class SQLPrimaryKeyColumnConstraint extends AbstractSQLConstraint implements ISQLPrimaryKeyColumnConstraint {
    ...
    public SQLPrimaryKeyColumnConstraint() {
    }

    public SQLPrimaryKeyColumnConstraint(ISQLName name) {
        super(name);
    }

    public SQLPrimaryKeyColumnConstraint(ISQLName name, boolean primary) {
        super(name);
