 ...
 */
public abstract class AbstractSQLCharDataType extends AbstractSQLStringDataType {

    protected SQLCharSizeUnit charSizeUnit;


    public AbstractSQLCharDataType() {
    }

    public AbstractSQLCharDataType(int length) {
        super(new SQLIntegerLiteral(length));
    }
