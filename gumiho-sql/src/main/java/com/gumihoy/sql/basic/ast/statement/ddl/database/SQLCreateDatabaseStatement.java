 ...
 */
public class SQLCreateDatabaseStatement extends AbstractSQLStatement implements ISQLCreateStatement {
...
//        }
    ...
    public SQLCreateDatabaseStatement setName(ISQLName name) {
        setChildParent(name);
        this.name = name;
        return this;
    }
