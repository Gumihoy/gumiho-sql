 ...
 */
public class SQLSequenceNoScaleOption extends AbstractSQLExpr implements ISQLCreateSequenceOption, ISQLAlterSequenceAction {
    ...
    @Override
    public SQLSequenceNoScaleOption clone() {
