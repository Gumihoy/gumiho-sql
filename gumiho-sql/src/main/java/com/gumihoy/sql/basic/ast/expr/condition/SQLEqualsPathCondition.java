 ...
 */
public class SQLEqualsPathCondition extends AbstractSQLExpr implements ISQLCondition {
...
//        }
    ...
    @Override
    public SQLEqualsPathCondition clone() {
        SQLEqualsPathCondition x = new SQLEqualsPathCondition();

        this.cloneTo(x);
        return x;
    }

    public void cloneTo(SQLEqualsPathCondition x) {
        super.cloneTo(x);
