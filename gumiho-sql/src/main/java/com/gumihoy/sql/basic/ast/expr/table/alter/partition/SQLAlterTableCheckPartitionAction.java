 ...
 */
public class SQLAlterTableCheckPartitionAction extends AbstractSQLExpr implements ISQLAlterTableAction {
...
//        }
    ...
    @Override
    public SQLAlterTableCheckPartitionAction clone() {
        SQLAlterTableCheckPartitionAction x = new SQLAlterTableCheckPartitionAction();
        this.cloneTo(x);
        return x;
    }

    public void cloneTo(SQLAlterTableCheckPartitionAction x) {
        super.cloneTo(x);
