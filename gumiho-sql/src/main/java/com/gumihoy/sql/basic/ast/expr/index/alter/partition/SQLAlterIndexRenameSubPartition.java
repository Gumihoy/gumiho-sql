 ...
 */
public class SQLAlterIndexRenameSubPartition extends AbstractSQLExpr implements ISQLAlterIndexPartitionAction {
    ...
    @Override
    public SQLAlterIndexRenameSubPartition clone() {
        return null;
    }
