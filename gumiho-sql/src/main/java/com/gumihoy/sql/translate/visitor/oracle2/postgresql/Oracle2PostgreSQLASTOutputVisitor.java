 ...
 */
public class Oracle2PostgreSQLASTOutputVisitor extends OracleASTOutputVisitor implements IPostgreSQLASTVisitor {

    protected PostgreSQLASTOutputVisitor postgreSQLSQLASTOutputVisitor;

    public Oracle2PostgreSQLASTOutputVisitor(StringBuilder appender, SQLOutputConfig config) {
        super(appender, config);
        postgreSQLSQLASTOutputVisitor = new PostgreSQLASTOutputVisitor(appender, config);
    }
